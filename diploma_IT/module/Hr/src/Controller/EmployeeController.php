	...
	**/
	public function addemployeeAction()
	{
		...
		if($this->getRequest()->isPost()):
			...
			$data1=array(
				...
				'full_name_dzo' => strtoupper($data['full_name_dzo']),
	...
	public function viewAction()
	{
		...
		return new ViewModel(array(
			...
			'qualification' => $this->getDefinedTable(Hr\QualificationTable::class),
	...
	public function viewqualificationAction()
	{
		...
		return new ViewModel(array(
				...
				'id' => $this->_id,
				'employee' => $this->getDefinedTable(Hr\EmployeeTable::class)->get($this->_id),
				'qualification' => $this->getDefinedTable(Hr\QualificationTable::class)->get(array('monk_id' => $emp['emp_id'])),
				'q_levelsObj' => $this->getDefinedTable(Hr\QualificationLevelTable::class),
				'program'=> $this->getDefinedTable(Academic\ProgramTable::class),
				'organization'=> $this->getDefinedTable(Administration\LocationTable::class),
				'country'=> $this->getDefinedTable(Administration\CountryTable::class),
	...
	public function addfamilyAction()
	{
		...
		if($this->getRequest()->isPost()){
			...
			$data=array(
					...
					'name_dzo' => $form->getPost('name_dzo'),
		...
		$data1 = $this->_safedataObj->rteSafe($data1);
		$result1 = $this->getDefinedTable(Academic\FamilyTable::class)->save($data1);
			if($result > 0):
