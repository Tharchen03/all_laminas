...
!(function (t, e) {
        ...
        "undefined" != typeof document &&
            ("function" == typeof attachEvent
                ...
                : "function" == typeof addEventListener &&
                  addEventListener(
                      "onpagehide" in P ? "pagehide" : "unload",
                      rt,
                      !1
                  ));
    var it =
    ...
    (ft.protocol = 4), ft.protocol;
    var lt,
        pt = "function" == typeof ArrayBuffer,
                ...
                r(t, [
                    {
                        key: "encode",
                        value: function (t) {
                            return (t.type !== lt.EVENT && t.type !== lt.ACK) ||
                                !mt(t)
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var e = "" + t.type;
                            return (
                                (t.type !== lt.BINARY_EVENT &&
                                    t.type !== lt.BINARY_ACK) ||
                                    (e += t.attachments + "-"),
                                t.nsp && "/" !== t.nsp && (e += t.nsp + ","),
                                null != t.id && (e += t.id),
                                null != t.data &&
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                if (
                                    n.type === lt.BINARY_EVENT ||
                                    n.type === lt.BINARY_ACK
                                ) {
                                    for (
                                        var r = e + 1;
                ...
                r(i, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            for (
                                ...
                                n[r - 1] = arguments[r];
                            n.unshift(t);
                            var i = { type: lt.EVENT, data: n, options: {} };
                            if (
                                ((i.options.compress =
                        ...
                        value: function () {
                            ...
                            "function" == typeof this.auth
                                ? this.auth(function (e) {
                                      t.packet({ type: lt.CONNECT, data: e });
                                  })
                                : this.packet({
                                      type: lt.CONNECT,
                                      data: this.auth,
                            ...
                            return function () {
                                if (!n) {
                                    ...
                                    for (
                                        ...
                                        i[o] = arguments[o];
                                    e.packet({ type: lt.ACK, id: t, data: i });
                                }
                            };
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return (
                                this.connected &&
                                    this.packet({ type: lt.DISCONNECT }),
                                this.destroy(),
                                this.connected &&
                ...
                r(s, [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            var i = At(n, "open", function () {
                                    r.onopen(), t && t();
                                }),
                                o = At(n, "error", function (n) {
                                    r.cleanup(),
    ...
    function Nt(e, n) {
        ...
        var r,
            ...
            s = i.id,
            a = i.path,
            c = St[s] && a in St[s].nsps;
        return (
            n.forceNew || n["force new connection"] || !1 === n.multiplex || c
                ? (r = new Bt(o, n))
                : (St[s] || (St[s] = new Bt(o, n)), (r = St[s])),
            i.query && !n.query && (n.query = i.queryKey),
            r.socket(i.path, n)
        );
    }
    return i(Nt, { Manager: Bt, Socket: Tt, io: Nt, connect: Nt }), Nt;
});
